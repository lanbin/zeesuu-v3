...
import { reactive, defineComponent, ref, computed, watch, onMounted, resolveComponent, openBlock, createElementBlock, createVNode, withCtx, Fragment, renderList, unref, createBlock, resolveDynamicComponent, mergeProps, withKeys, createElementVNode, renderSlot, createTextVNode, toDisplayString, createCommentVNode, pushScopeId, popScopeId } from "vue";
...
var useSearchTable = () => {
  ...
  const defaultDatePickerConfig = (_a) => {
    var _b = _a, { label } = _b, res = __objRest(_b, ["label"]);
...
const _withScopeId = (n) => (pushScopeId("data-v-ca0635ac"), n = n(), popScopeId(), n);
const _hoisted_1 = { class: "search-table-box" };
const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", null, "123", -1));
const _hoisted_3 = { class: "search-table-btn-box" };
const _hoisted_4 = {
  key: 0,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit: emits }) {
    const { options } = __props;
    const { tableConfig } = useSearchTable();
    const tableData = ref([]);
    const searchData = reactive({});
    const preSearchData = ref({});
    const initSearchData = reactive({});
    const innerConfig = computed(() => {
      return reactive(merge$1(tableConfig, options));
    });
    watch(() => options.staticData, () => {
      if (!innerConfig.value.fetchMethod) {
        fetchData();
      }
    });
    const hasFormOptions = computed(() => {
      var _a;
      if ((_a = innerConfig == null ? void 0 : innerConfig.value) == null ? void 0 : _a.formOptions)
        return innerConfig.value.formOptions.length > 0;
      return false;
    });
    ...
    const updateStaticDataConfig = () => {
      var _a, _b;
      innerConfig.value.pageAttrs.total = (_a = options.staticData) == null ? void 0 : _a.length;
      tableData.value = (_b = clone(options.staticData)) == null ? void 0 : _b.splice((innerConfig.value.pageAttrs.page - 1) * innerConfig.value.pageAttrs.size, innerConfig.value.pageAttrs.size);
    };
    const fetchData = async (params) => {
      var _a;
      if (params == null ? void 0 : params.firstPage) {
      ...
      if (Array.isArray(innerConfig.value.staticData) && !innerConfig.value.fetchMethod) {
        ...
        if (innerConfig.value.fetchMethod) {
          ...
          const result = await innerConfig.value.fetchMethod(__spreadProps(__spreadValues({}, searchData), {
            page: innerConfig.value.pageAttrs.page,
            size: innerConfig.value.pageAttrs.size
          }));
          innerConfig.value.pageAttrs.total = result.total;
          tableData.value = result[((_a = innerConfig == null ? void 0 : innerConfig.value) == null ? void 0 : _a.listName) || "rows"];
    ...
    const updateSearchFormData = (defaultFormData) => {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createVNode(_component_ElRow, {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(innerConfig).formOptions, (formItem, index2) => {
              return openBlock(), createBlock(_component_ElCol, {
                span: 24 / unref(innerConfig).itemPerRow,
                key: index2
              }, {
                default: withCtx(() => {
                  var _a;
                  return [
                    (openBlock(), createBlock(resolveDynamicComponent(formItem.type), mergeProps({
                      label: formItem.label,
                      conf: formItem.conf,
                      clearable: true,
                      placeholder: ((_a = formItem.$attrs) == null ? void 0 : _a.placeholder) || formItem.label,
                      onKeyup: _cache[0] || (_cache[0] = withKeys(($event) => fetchData({ firstPage: true }), ["enter"]))
                    }, formItem.$attrs, {
                      modelValue: unref(searchData)[formItem.name],
                      "onUpdate:modelValue": ($event) => unref(searchData)[formItem.name] = $event,
                      style: { "width": "100%" }
                    }), null, 16, ["label", "conf", "placeholder", "modelValue", "onUpdate:modelValue"]))
                  ];
                }),
                _: 2
              }, 1032, ["span"]);
        ...
        createElementVNode("div", _hoisted_3, [
          renderSlot(_ctx.$slots, "before-btn", {}, void 0, true),
          unref(hasFormOptions) ? (openBlock(), createBlock(_component_ElButton, {
            key: 0,
            type: "primary",
            onClick: _cache[1] || (_cache[1] = ($event) => fetchData({ firstPage: true })),
            icon: unref(Search)
          }, {
            default: withCtx(() => [
              createTextVNode(toDisplayString(unref(innerConfig).queryBtnText), 1)
            ]),
            _: 1
          }, 8, ["icon"])) : createCommentVNode("", true),
          unref(innerConfig).showResetBtn && unref(hasFormOptions) ? (openBlock(), createBlock(_component_ElButton, {
            key: 1,
            onClick: resetSearchData,
            icon: unref(DeleteFilled)
          }, {
            default: withCtx(() => [
              createTextVNode(toDisplayString(unref(innerConfig).resetBtnText), 1)
            ]),
            _: 1
          }, 8, ["icon"])) : createCommentVNode("", true),
          renderSlot(_ctx.$slots, "after-btn", {}, void 0, true)
        ]),
        createVNode(_component_ElTable, mergeProps({
          data: tableData.value,
          border: true
        }, unref(innerConfig).tableAttrs), {
          default: withCtx(() => [
            renderSlot(_ctx.$slots, "default", {}, void 0, true)
          ]),
          _: 3
        }, 16, ["data"]),
        unref(innerConfig).pageAttrs.show ? (openBlock(), createElementBlock("div", _hoisted_4, [
          createVNode(_component_ElPagination, {
            layout: unref(innerConfig).pageAttrs.layout,
            "current-page": unref(innerConfig).pageAttrs.page,
            "page-size": unref(innerConfig).pageAttrs.size,
            total: unref(innerConfig).pageAttrs.total,
            "page-sizes": unref(innerConfig).pageAttrs.pageSizes,
            onCurrentChange: pageChanged,
            onSizeChange: sizeChanged
          }, null, 8, ["layout", "current-page", "page-size", "total", "page-sizes"])
        ])) : createCommentVNode("", true)
      ]);
    };
  }
});
var SearchTable = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ca0635ac"]]);
var index = {
  install(Vue) {
